...
public class PacketResolverTest {
    ...
    @Test
    public void testA() {
        String based64DemoData = "AAABgAAQAAIAAAAFAAAAAHjabJCxihUxFIYvgr3PcOoUyUySyaQTtbBRWBYsREI2OTsbmEkuSa4" +
    ...
    @Test
    public void testB() {
        String based64DemoData = "AAAB9AAQAAIAAAAFAAAAAHjatJJBixM/GMaHhf/hf/MzvOcckpk00+akqAcvCsuCB5GQnWS7gZl" +
    ...
    @Test
    public void testC() {
        String based64DemoData = "AAAA3AAQAAIAAAAFAAAAAHjaRM6xSgNBEAbgS2HvM/z1X8zszu7eXRcQrWIjVushel5AiYnopQr" +
    ...
    @Test
    public void testD() {
        String based64DemoData = "AAABGwAQAAIAAAAFAAAAAHjaTE8xSzNBFLyv+Hp/w9SveO92993udRLBKjZitR4hRCNCcld4ViF" +
    ...
    private void resolver(String based64DemoData) {
        byte[] demoData = Base64.decodeBase64(based64DemoData);
