package net.dengzixu.java.payload.constant;

public class BodyType {
    public static final String DANMU_MSG = "DANMU_MSG";
    public static final String INTERACT_WORD = "INTERACT_WORD";
    public static final String WELCOME_GUARD = "WELCOME_GUARD";
    public static final String ENTRY_EFFECT = "ENTRY_EFFECT";
    public static final String WELCOME = "WELCOME";
    public static final String SUPER_CHAT_MESSAGE_JPN = "SUPER_CHAT_MESSAGE_JPN";
    ...
    public static final String STOP_LIVE_ROOM_LIST = "STOP_LIVE_ROOM_LIST";
